...
<html lang="en">
  ...
  $result = $conn->query($sql1); $couponNames = array(); if ($result->num_rows >
    ...
    */ ?>
    ...
    ></div>
    <div
      class="w-[40rem] h-[24rem] top[50%] left-[50%] bg-gray-900 z-20 absolute drop-shadow-md flex rounded-md opacity-0 pointer-events-none translate-x-[-50%] translate-y-[30%] transition-all duration-500 ease-in-out"
      id="modal"
    >
    ...
    <header class="px-28">
      ...
      >
        <ul class="flex gap-14 list-none">
          <li>
            <a href="#" class="hover:text-pink-700 transition-all duration-300"
              >Home</a
            >
          </li>
          <li>
      ...
      <div class="h-96">
        ...
        <form action="">
          <div
            class="bg-white w-1/4 flex items-center justify-between rounded-l-3xl rounded-r-xl absolute right-0 mr-28 drop-shadow-md"
          >
            <input
        ...
        <div class="flex justify-between pt-14">
          <div class="flex flex-col items-center w-1/3">
            <h1
              class="text-7xl font-bold w-56 text-center tracking-wide text-slate-700 py-8"
            >
              Save Money Shop Smart
            </h1>
            <button
              class="border text-lg bg-pink-500 text-white px-12 py-2 rounded-lg mt-5 hover:bg-pink-600 transition-all duration-500"
            >
              Get Coupons
            </button>
          </div>
    ...
    <!-- Carassol -->
    <div
      class="carousel overflow-hidden flex justify-center items-center relative"
    >
      <div
        id="leftButton"
        class="w-[1rem] h-[1rem] absolute left-20 cursor-pointer"
      >
        <img
          src="img/left.svg"
          class="w-full h-full object-contain"
          alt="get best deals image"
        />
      </div>
      <ul
      ...
      <div
        id="rightButton"
        class="w-[1rem] h-[1rem] absolute right-20 cursor-pointer"
      >
        <img
          src="img/right.svg"
          class="w-full h-full object-contain"
