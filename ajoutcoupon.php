    ...
    <div class="details" style="align-items: center; top: 70px;">
        <div class="GS">
            <div class="cardHeader">
                <h2>Ajouter Coupon</h2>
            </div>
            <form method="post" action="ajout_COUP.php">
                <table>
                    <tbody>
                        <tr>
                            <td>
                            ...
                            <td>
                                ...
                                <input type="number" name="poursentage" id="poursentage" style="padding: 12px; width: 200px; border-radius: 10px;" >
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="date" name="date_debut" id="date_debut" style="padding: 12px; width: 200px; border-radius: 10px;" >
                            </td>
                            <td>
                                <label for="date_fin">Date de fin :</label>
                                <input type="date" name="date_fin" id="date_fin" style="padding: 12px; width: 200px; border-radius: 10px;" >
                            </td>
                        </tr>
        ...
        <select name="id_mark" id="id_mark" style="padding: 12px; width: 200px; border-radius: 10px;">
            ...
            ?>
                        ...
                        <tr>
                            <td>
                                <button class="btn" style="width: 100px; height: 40px;" type="submit">Ajouter Coupon</button>
                            </td>
                            <td>
