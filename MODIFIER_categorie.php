...
<div class="container">
   ...
   <div class="details" style="align-items: center; top: 70px;">
        <div class="GS">
                ...
                <table>
    <form method="post" action="modefier_categorie.php">
                    <tbody>
                        <tr>
                            <td>
                                <label for="salle">Nouveau nom de Catégorie :</label>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <button class="btn" style="width: 100px; height: 40px;">Modifier Catégorie</button>
                            </td>
                                </form>
                            <td>
