   ...
   <div class="details">
        <div class="GS">
                <div class="cardHeader">
                    ...
                    <button class="btn"><a href="ajoutcoupon.php">AJOUTER COUPON</a></button>
                </div>
<?php
...
$sqlcoup = 'SELECT coupon.*, mark.nom_mark FROM coupon INNER JOIN mark ON mark.id_mark = coupon.id_mark';
...
echo '<table>';
echo '<tr>';
echo '<th>ID DE COUPON</th>';
echo '<th>NOM</th>';
echo '<th>POURCENTAGE</th>';
echo '<td>DATE DE DEBUT</td>';
echo '<td>DATE DE FIN</td>';
echo '<th>NOM DE MARK</th>';
echo '<td></td>';
echo '</tr>';
foreach ($nbr_coup as $ligne) {
    echo '<tr>';
    echo '<td>' . $ligne['id_coupon'] . '</td>';
    echo '<td>' . $ligne['nom_coupon'] . '</td>';
    echo '<td>' . $ligne['poursentage'] . ' % </td>';
    echo '<td>' . $ligne['date_debut'] . '</td>';
    echo '<td>' . $ligne['date_fin'] . '</td>';
    echo '<td>' . $ligne['nom_mark'] . '</td>';
    echo "<td>" . "<button class=" . "btn" . ">" . "<a href=" . "SUPPRIME_coupon.php?id=" . $ligne['id_coupon'] . ">" . "SUPPRIMER" . "</a>" . "</button>" . "</td>";
    echo "<td>" . "<button class=" . "btn" . ">" . "<a href=" . "MODIFIER_coupon.php?id=" . $ligne['id_coupon'] . ">" . "MODIFIER" . "</a>" . "</button>" . "</td>";
    echo '</tr>';
}
echo '</table>';
?>
