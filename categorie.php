   ...
   <div class="details">
        <div class="GS">
                <div class="cardHeader">
                    ...
                    <button class="btn"><a href="ajoutcategorie.php">AJOUTER CATEGORIE</a></button>
                </div>
<?php
...
echo '<table>';
echo '<tr>';
echo '<th>ID DE CATEGORIE</th>';
echo '<th>NOM</th>';
//echo '<td></td>';
echo '</tr>';
foreach ($nbr_cat as $ligne) {
    echo '<tr>';
    echo '<td>' . $ligne['id_cat'] . '</td>';
    echo '<td>' . $ligne['nom_cat'] . '</td>';
    echo "<td>"."<button class="."btn".">"."<a href="."SUPPRIME_categorie.php?id=".$ligne['id_cat'].">"."SUPPRIMER"."</a>"."</button>"."</td>";
    echo "<td>"."<button class="."btn".">"."<a href="."MODIFIER_categorie.php?id=".$ligne['id_cat'].">"."MODIFIER"."</a>"."</button>"."</td>";
    echo '</tr>';
}
echo '</table>';
?>
